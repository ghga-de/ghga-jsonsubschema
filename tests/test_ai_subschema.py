...
housing_schema = {
    ...
    "properties": {
        ...
        "y": {
            ...
            "minItems": 16512,
            "maxItems": 16512,
            "items": {"description": "target", "type": "number"},
        },
    },
}
        ...
        "X": {
            ...
            "items": {
                ...
                "items": [
                    ...
                    {
                        "description": "marital-status_Married-AF-spouse",
                        "enum": [0, 1],
                    },
                    {
                        "description": "marital-status_Married-civ-spouse",
                        "enum": [0, 1],
                    },
                    {
                        "description": "marital-status_Married-spouse-absent",
                        "enum": [0, 1],
                    },
                    ...
                    {
                        "description": "native-country_Dominican-Republic",
                        "enum": [0, 1],
                    },
                    ...
                    {
                        "description": "native-country_Holand-Netherlands",
                        "enum": [0, 1],
                    },
                    ...
                    {
                        "description": "native-country_Outlying-US(Guam-USVI-etc)",
                        "enum": [0, 1],
                    },
                    ...
                    {
                        "description": "native-country_Trinadad&Tobago",
                        "enum": [0, 1],
                    },
        ...
        "X": {
            ...
            "items": {
                ...
                "items": [
                    ...
                    {
                        "description": "Horizontal_Distance_To_Hydrology",
                        "type": "integer",
                    },
                    {
                        "description": "Vertical_Distance_To_Hydrology",
                        "type": "integer",
                    },
                    {
                        "description": "Horizontal_Distance_To_Roadways",
                        "type": "integer",
                    },
